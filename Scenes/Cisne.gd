...
func _ready():
	...
	t.piezas[1].pos_ini = Vector2(2.0,-4.0)
	t.piezas[1].grados = 180.0
	t.piezas[2].grados = 270.0
	t.piezas[2].pos_ini = Vector2(-4.0,0.0)
	t.piezas[3].grados = 90.0
	t.piezas[3].pos_ini = Vector2(-6.0, -5.0)
	t.piezas[4].grados = 45.0
	t.piezas[4].pos_ini = Vector2(-6.5, -9.0)
	t.piezas[5].grados = 45.0
	t.piezas[5].pos_ini = Vector2(-6.0,-5.0)
	t.piezas[6].grados =  90.0
	t.piezas[6].pos_ini = Vector2(-4.5, -9.0)
